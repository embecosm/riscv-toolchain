...
case ${opt} in
    ...
    --help)
        ...
        echo "	riscv-coreplexip-e31-arty"
        echo "	riscv-coreplexip-e31-arty-rtos"
        echo "	riscv-coreplexip-e51-arty"
        echo "	riscv-coreplexip-e51-arty-rtos"
        echo ""
        exit 1
        ;;
...
case "${TARGET_BOARD}" in
    riscv-freedom-e310-arty|riscv-coreplexip-e31-arty|riscv-coreplexip-e51-arty|riscv-coreplexip-e31-arty-rtos|riscv-coreplexip-e51-arty-rtos)
